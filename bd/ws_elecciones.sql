...
--
CREATE OR REPLACE FUNCTION ws_elecciones(_anio INT, _nombre_tipo_resultado VARCHAR, _id_dpa INT, _id_tipo_dpa INT, _id_eleccion INT, _id_partido_antecesor INT, _id_partido INT)
  RETURNS
